...
mediawiki_api_endpoint = 'https://ld4-wbs-test.wikibase.cloud/w/api.php'

# SPARQL endpoint
wikibase_sparql_endpoint = 'https://ld4-wbs-test.wikibase.cloud/query/sparql'

# Name of the Wikibase instance
wikibase_name = 'LD4 WBStack Test'

# URL of the main page of the Wikibase instance
wikibase_main_page = 'https://ld4-wbs-test.wikibase.cloud/wiki/Main_Page'
...
identifier_space = 'http://ld4-wbs-test.wikibase.cloud/wiki/Special:EntityData/'
...
qid_url_pattern = 'https://ld4-wbs-test.wikibase.cloud/wiki/Item:{{id}}'
...
service_name = 'LD4 WBStack Test test reconciliation service'
